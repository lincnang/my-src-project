...
public class L1Config {
    ...
    public static int _220076 = 220076;
    /**
     * 大樂透系統
     */
     ...
     * 假人
     */
    public static int _9319 = Integer.valueOf(L1SystemMessageTable.get().getTemplate(9319).getMessage());
    public static int _9320 = Integer.valueOf(L1SystemMessageTable.get().getTemplate(9320).getMessage());
    public static int _9321 = Integer.valueOf(L1SystemMessageTable.get().getTemplate(9321).getMessage());
    public static int _9322 = Integer.valueOf(L1SystemMessageTable.get().getTemplate(9322).getMessage());
    public static int _9323 = Integer.valueOf(L1SystemMessageTable.get().getTemplate(9323).getMessage());
    public static int _9324 = Integer.valueOf(L1SystemMessageTable.get().getTemplate(9324).getMessage());
    public static int _9325 = Integer.valueOf(L1SystemMessageTable.get().getTemplate(9325).getMessage());
    public static int _9326 = Integer.valueOf(L1SystemMessageTable.get().getTemplate(9326).getMessage());
}
