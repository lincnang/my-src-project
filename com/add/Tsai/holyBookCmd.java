            ...
            for (int i = 0; i <= size; i++) {
                ...
                if (holy1 != null) {//列表ID空白不啟動
                    if (dollQuestTable.get().IsQuest(pc, holy1.getQuestId())) {
                        stringBuilder.append(String.valueOf(holy1.getAddcgfxid()) + ",");
                    } else {
                        stringBuilder.append(String.valueOf(holy1.getAddhgfxid()) + ",");
                    }
                }
            }
            ...
            for (int i = 0; i <= holyTable.get().holySize(); i++) {//檢查變身卡DB資料
                ...
                if (holy != null) {//檢查變身卡DB資料
                    if (cmd.equals(holy.getCmd())) {//檢查變身卡DB資料
                        ...
                        if (dollQuestTable.get().IsQuest(pc, holy.getQuestId())) {
                            stringBuilder.append(holy.getAddcgfxid() + ",");    // 0
                        } else {
                            stringBuilder.append(holy.getAddhgfxid() + ",");    // 0
                        }
                        stringBuilder.append(holy.getMsg2() + ",");//1
                        stringBuilder.append(holy.getMsg1() + ",");//2
