...
public final class ConfigMagic {
    private static final Log _log = LogFactory.getLog(ConfigMagic.class);
    private static final String ALT_SETTINGS_FILE = "./config/技能卡合成設定.properties";
    public static int[] Magic_LIST_1;//給與魔法列陣
    public static int[] Magic_LIST_2;//給與魔法列陣
    public static int[] Magic_LIST_3;//給與魔法列陣
    public static int[] Magic_LIST_4;//給與魔法列陣
    public static int[] Magic_LIST_5;//給與魔法列陣
    ...
    public static List<Integer> Magic1 = new ArrayList<Integer>();//倉庫封包判定1階段
    public static List<Integer> Magic2 = new ArrayList<Integer>();//倉庫封包判定2階段
    public static List<Integer> Magic3 = new ArrayList<Integer>();//倉庫封包判定3階段
    public static List<Integer> Magic4 = new ArrayList<Integer>();//倉庫封包判定4階段
    ...
    public static void load() throws ConfigErrorException {
        ...
        try {
            ...
            set.load(isr);
            is.close();
            Magic_LIST_1 = toIntArray(set.getProperty("Magic_List1", ""), ",");
            Magic_LIST_2 = toIntArray(set.getProperty("Magic_List2", ""), ",");
            Magic_LIST_3 = toIntArray(set.getProperty("Magic_List3", ""), ",");
            Magic_LIST_4 = toIntArray(set.getProperty("Magic_List4", ""), ",");
            Magic_LIST_5 = toIntArray(set.getProperty("Magic_List5", ""), ",");
            ...
            if (set.getProperty("Magic1") != null) {
                for (final String str : set.getProperty("Magic1").split(",")) {
                    Magic1.add(Integer.parseInt(str));
                }
            }
            if (set.getProperty("Magic2") != null) {
                for (final String str : set.getProperty("Magic2").split(",")) {
                    Magic2.add(Integer.parseInt(str));
                }
            }
            if (set.getProperty("Magic3") != null) {
                for (final String str : set.getProperty("Magic3").split(",")) {
                    Magic3.add(Integer.parseInt(str));
                }
            }
            if (set.getProperty("Magic4") != null) {
                for (final String str : set.getProperty("Magic4").split(",")) {
                    Magic4.add(Integer.parseInt(str));
                }
            }
        } catch (Exception e) {
            ...
            set.clear();
            _log.info("Config/魔法合成設定讀取完成 (" + timer.get() + "ms)");
        }
    }
