...
public final class ConfigMagic {
    ...
    public static List<Integer> Magic1 = new ArrayList<>();//倉庫封包判定1階段
    public static List<Integer> Magic2 = new ArrayList<>();//倉庫封包判定2階段
    public static List<Integer> Magic3 = new ArrayList<>();//倉庫封包判定3階段
    public static List<Integer> Magic4 = new ArrayList<>();//倉庫封包判定4階段
