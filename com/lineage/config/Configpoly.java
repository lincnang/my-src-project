...
public final class Configpoly {
    ...
    public static List<Integer> poly1 = new ArrayList<Integer>();//倉庫封包判定1階段
    public static List<Integer> poly2 = new ArrayList<Integer>();//倉庫封包判定2階段
    public static List<Integer> poly3 = new ArrayList<Integer>();//倉庫封包判定3階段
    public static List<Integer> poly4 = new ArrayList<Integer>();//倉庫封包判定4階段
