 ...
 * @author hero
 */
public class Dolls extends ItemExecutor {
    private static String[] BOOK_HTML = new String[]{"Book_D02", "Book_D03", "Book_D04", "Book_D05", "Book_D06", "Book_D07", "Book_D08",};
    private static Dolls _instance;
    ...
    public static Dolls getInstance() {
        if (_instance == null) {
            _instance = new Dolls();
        }
        return _instance;
