 ...
 * @author hero
 */
public class Dolls2 extends ItemExecutor {
    private static Dolls2 _instance;
    private int _quest;
    private int _gfx;
    private int _itemid;
    ...
    public static Dolls2 getInstance() {
        if (_instance == null) {
            _instance = new Dolls2();
        }
        return _instance;
    }
    ...
    public void execute(int[] data, L1PcInstance pc, L1ItemInstance item) {
        ...
        pc.sendPackets(new S_NPCTalkReturn(pc, "Book_03", msg));
        if (ok) {
