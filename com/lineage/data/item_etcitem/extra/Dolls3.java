 ...
 * @author hero
 */
public class Dolls3 extends ItemExecutor {
    private static Dolls3 _instance;
    private int _quest;
    private int _gfx;
    private int _itemid;
    ...
    public static Dolls3 getInstance() {
        if (_instance == null) {
            _instance = new Dolls3();
        }
        return _instance;
    }
    ...
    public void execute(int[] data, L1PcInstance pc, L1ItemInstance item) {
        ...
        pc.sendPackets(new S_NPCTalkReturn(pc, "Book_04", msg));
        if (ok) {
