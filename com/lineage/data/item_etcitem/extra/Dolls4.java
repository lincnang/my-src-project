 ...
 * @author hero
 */
public class Dolls4 extends ItemExecutor {
    private static Dolls4 _instance;
    private int _quest;
    private int _gfx;
    private int _itemid;
    ...
    public static Dolls4 getInstance() {
        if (_instance == null) {
            _instance = new Dolls4();
        }
        return _instance;
    }
    ...
    public void execute(int[] data, L1PcInstance pc, L1ItemInstance item) {
        ...
        pc.sendPackets(new S_NPCTalkReturn(pc, "Book_05", msg));
        if (ok) {
