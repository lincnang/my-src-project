 ...
 * @author hero
 */
public class Dolls5 extends ItemExecutor {
    private static Dolls5 _instance;
    private int _quest;
    private int _gfx;
    private int _itemid;
    ...
    public static Dolls5 getInstance() {
        if (_instance == null) {
            _instance = new Dolls5();
        }
        return _instance;
    }
    ...
    public void execute(int[] data, L1PcInstance pc, L1ItemInstance item) {
        ...
        pc.sendPackets(new S_NPCTalkReturn(pc, "Book_06", msg));
        if (ok) {
