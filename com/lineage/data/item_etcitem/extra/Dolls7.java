 ...
 * @author hero
 */
public class Dolls7 extends ItemExecutor {
    private static Dolls7 _instance;
    private int _quest;
    private int _gfx;
    private int _itemid;
    ...
    public static Dolls7 getInstance() {
        if (_instance == null) {
            _instance = new Dolls7();
        }
        return _instance;
    }
    ...
    public void execute(int[] data, L1PcInstance pc, L1ItemInstance item) {
        ...
        pc.sendPackets(new S_NPCTalkReturn(pc, "Book_08", msg));
        if (ok) {
