...
public class BlessReelAoor extends ItemExecutor {
    private int _random = 0;

    private BlessReelAoor() {
        // TODO Auto-generated constructor stub
    }

    public static ItemExecutor get() {
        return new BlessReelAoor();
    }
    ...
    public void execute(int[] data, L1PcInstance pc, L1ItemInstance item) {
        ...
        if (targetItem.getItem().getType() <= 7) {
            pc.sendPackets(new S_ServerMessage(79));
            return;
        }
        if (targetItem.getBless() == 0) {
            pc.sendPackets(new S_SystemMessage("你的首飾已經祝福過了."));
            return;
        }
        ...
        if (rnd.nextInt(100) < _random) {
            ...
            WriteLogTxt.Recording("祝福飾品記錄", "人物:" + pc.getName() + "把" + targetItem.getName() + " 祝福成功" + " 物品OBJID:" + targetItem.getId());
        } else {
            if (zhufu.getzhufu()) {
            ...
            WriteLogTxt.Recording("祝福飾品記錄", "人物:" + pc.getName() + "把" + targetItem.getName() + " 祝福失敗" + " 物品OBJID:" + targetItem.getId());
        }
    }
}
