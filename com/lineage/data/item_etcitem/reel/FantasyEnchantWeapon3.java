    ...
    /*else if (tgItem.getproctect1() == true) {
      ...
      pc.getInventory().saveItem(tgItem, 4);
            ...
            if ((!tgItem.getproctect()) /*|| (!tgItem.getproctect1()) || (!tgItem.getproctect2())*/)
                ;
            //ConfigRecord.recordToFiles("達人武卷強化失敗記錄", "IP(" + pc.getNetConnection().getIp() + ")" + "玩家" + ":【" + pc.getName() + "】" + "的" + "【+" + tgItem.getEnchantLevel() + " " + tgItem.getName() + "】- 強化失敗" + ",時間:" + "(" + new Timestamp(System.currentTimeMillis()) + ")。");
        }
    }
}