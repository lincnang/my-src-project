 ...
 * 古代人的咒術卷軸<br>
 */
public class ScrollEnchantArmor_D extends ItemExecutor {//20161201

    /**
     *
     */
    private ScrollEnchantArmor_D() {
        // TODO Auto-generated constructor stub
    }

    public static ItemExecutor get() {
        return new ScrollEnchantArmor_D();
    }
    ...
    public void execute(final int[] data, final L1PcInstance pc, final L1ItemInstance item) {
        ...
        if ((armorId >= 120493) && (armorId <= 120500)) { // 屍魂裝備
            isErr = false;
        } else {
            isErr = true;
        }
