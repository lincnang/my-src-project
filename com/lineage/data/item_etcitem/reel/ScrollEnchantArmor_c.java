...
/**
 * 240252	死亡騎士脛甲強化卷<br>
 * 240253	死亡騎士脛甲強化卷(詛咒)<br>
 * 240254	死亡騎士脛甲強化卷(祝福)<br>
 */
public class ScrollEnchantArmor_c extends ItemExecutor {//20161201

    /**
     *
     */
    private ScrollEnchantArmor_c() {
        // TODO Auto-generated constructor stub
    }

    public static ItemExecutor get() {
        return new ScrollEnchantArmor_c();
    }
    ...
    public void execute(final int[] data, final L1PcInstance pc, final L1ItemInstance item) {
        ...
        if ((armorId >= 120477) && (armorId <= 120479)) { // 20170108死亡騎士脛甲
            isErr = false;
        } else {
            isErr = true;
        }
        ...
        if (tgItem.getEnchantLevel() == 9) {//20170108
