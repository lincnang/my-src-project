 ...
 * @author 老爹
 */
public class NewAuto extends ItemExecutor {
    private static final Log _log = LogFactory.getLog(NewAuto.class);
    private static NewAuto _instance;

    public static ItemExecutor get() {
        return new NewAuto();
    }

    public static NewAuto getInstance() {
        if (_instance == null) {
            _instance = new NewAuto();
        }
        return _instance;
    }
