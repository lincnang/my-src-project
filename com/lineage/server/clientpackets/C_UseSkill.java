...
public class C_UseSkill extends ClientBasePacket {
     ...
     */
    // 隱身狀態下可用的魔法
    private static final int[] _cast_with_invis = {/* HEAL,*/ LIGHT, SHIELD, TELEPORT,/* HOLY_WEAPON,*/ CURE_POISON,/* ENCHANT_WEAPON, */DETECTION, 14, 19, 21, 26, 31, 32, 35, 37, 42, 43, 44, 48, 49, 52, 54, 55, 57, 60, 61, 63, 67, 68, 69, 72, 73, 75, IMMUNE_TO_HARM2, 78, 79, REDUCTION_ARMOR, BOUNCE_ATTACK, SOLID_CARRIAGE, COUNTER_BARRIER, 97, 98, 99, 100, 101, 102, 104, 105, 106, 107, 109, 110, 111, 113, 114, 115, 116, 117, 118, 129, 130, 131, 133, 134, 137, 138, 146, 147, 148, 149, 150, 151, 155, 156, 158, 159, 163, 164, 165, 166, 168, 169, 170, 171, SOUL_OF_FLAME, ADDITIONAL_FIRE, DRAGON_SKIN, AWAKEN_ANTHARAS, AWAKEN_FAFURION, AWAKEN_VALAKAS, MIRROR_IMAGE, ILLUSION_OGRE, ILLUSION_LICH, PATIENCE, ILLUSION_DIA_GOLEM, INSIGHT, ASSASSIN, // 黑妖新技能 暗殺者
            ILLUSION_AVATAR};
