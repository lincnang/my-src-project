...
public class DungeonTable {
    ...
    public void load() {
        ...
        _log.info("讀取->地圖切換點設置數量: " + _dungeonMap.size() + "(" + timer.get() + "ms)");
    }
