...
public class SprTable {
    ...
    private static class Spr {
        private final Map<Integer, Integer> _moveSpeed = new HashMap<>();
        private final Map<Integer, Integer> _attackSpeed = new HashMap<>();
        private final Map<Integer, int[]> _frame = new HashMap<>();// 7.6
