...
public class IMMUNE_TO_HARM extends SkillMode { //SRC0808
    public int start(L1PcInstance srcpc, L1Character cha, L1Magic magic, int integer) throws Exception {
        ...
        if ((cha instanceof L1PcInstance)) {
            ...
            if (srcpc.getMeteLevel() < 2) {
                if (pc.hasSkillEffect(IMMUNE_TO_HARM2)) {
                ...
                for (L1PcInstance find_pc : World.get().getI2MPlayer(pc)) {
                    // 組隊與血盟人員
                    if ((party != null && party.isMember(find_pc)) || (pc.getClanid() != 0 && pc.getClanid() == find_pc.getClanid())) {
                        if (find_pc.hasSkillEffect(IMMUNE_TO_HARM2)) {
                            find_pc.removeSkillEffect(IMMUNE_TO_HARM2);
                        }
    ...
    public void stop(L1Character cha) throws Exception {
        if (cha instanceof L1PcInstance) {
            L1PcInstance pc = (L1PcInstance) cha;
            //            pc.removeSkillEffect(IMMUNE_TO_HARM);
