 ...
 * 樂天堂火神製作(DB化)
 */
public final class Read_Sha {
    private static Descriptors.FileDescriptor descriptor;
    private static final Descriptors.Descriptor readSha_descriptor = getDescriptor().getMessageTypes().get(14);
    private static final GeneratedMessageV3.FieldAccessorTable readSha_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(readSha_descriptor, new String[]{"Sha"});
    ...
    public static abstract interface readShaOrBuilder extends MessageOrBuilder {
        public abstract boolean hasSha();

        public abstract ByteString getSha();
    }

    public static final class readSha extends GeneratedMessageV3 implements Read_Sha.readShaOrBuilder {
        public static final int SHA_FIELD_NUMBER = 1;
        @Deprecated
        public static final Parser<readSha> PARSER = new AbstractParser<readSha>() {
            public Read_Sha.readSha parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new Read_Sha.readSha(input, extensionRegistry);
            }
        };
        private static final long serialVersionUID = 0L;
        private static final readSha DEFAULT_INSTANCE = new readSha();
        private int bitField0_;
        private ByteString sha_;
        private byte memoizedIsInitialized = -1;

        private readSha(GeneratedMessageV3.Builder<?> builder) {
            super(builder);
        }
        ...
        private readSha(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this();
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return Read_Sha.readSha_descriptor;
        }

        public static readSha parseFrom(ByteString data) throws InvalidProtocolBufferException {
            return (readSha) PARSER.parseFrom(data);
        }

        public static readSha parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (readSha) PARSER.parseFrom(data, extensionRegistry);
        }

        public static readSha parseFrom(byte[] data) throws InvalidProtocolBufferException {
            return (readSha) PARSER.parseFrom(data);
        }

        public static readSha parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (readSha) PARSER.parseFrom(data, extensionRegistry);
        }

        public static readSha parseFrom(InputStream input) throws IOException {
            return (readSha) GeneratedMessageV3.parseWithIOException(PARSER, input);
        }

        public static readSha parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (readSha) GeneratedMessageV3.parseWithIOException(PARSER, input, extensionRegistry);
        }

        public static readSha parseDelimitedFrom(InputStream input) throws IOException {
            return (readSha) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input);
        }

        public static readSha parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (readSha) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input, extensionRegistry);
        }

        public static readSha parseFrom(CodedInputStream input) throws IOException {
            return (readSha) GeneratedMessageV3.parseWithIOException(PARSER, input);
        }

        public static readSha parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (readSha) GeneratedMessageV3.parseWithIOException(PARSER, input, extensionRegistry);
        }
        ...
        public static Builder newBuilder(readSha prototype) {
            return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
        }

        public static readSha getDefaultInstance() {
            return DEFAULT_INSTANCE;
        }

        public static Parser<readSha> parser() {
            return PARSER;
        }
        ...
        protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return Read_Sha.readSha_fieldAccessorTable.ensureFieldAccessorsInitialized(readSha.class, Builder.class);
        }
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if ((this.bitField0_ & 0x1) == 1) {
                size = size + CodedOutputStream.computeBytesSize(1, this.sha_);
            }
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof readSha)) {
                return super.equals(obj);
            }
            readSha other = (readSha) obj;
            boolean result = true;
            result = (result) && (hasSha() == other.hasSha());
            if (hasSha()) {
                result = (result) && (getSha().equals(other.getSha()));
            }
        ...
        public Parser<readSha> getParserForType() {
            return PARSER;
        }

        public readSha getDefaultInstanceForType() {
            return DEFAULT_INSTANCE;
        }

        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements Read_Sha.readShaOrBuilder {
            private int bitField0_;
            ...
            protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
                return Read_Sha.readSha_fieldAccessorTable.ensureFieldAccessorsInitialized(Read_Sha.readSha.class, Builder.class);
            }
            ...
            public Read_Sha.readSha getDefaultInstanceForType() {
                return Read_Sha.readSha.getDefaultInstance();
            }

            public Read_Sha.readSha build() {
                Read_Sha.readSha result = buildPartial();
            ...
            public Read_Sha.readSha buildPartial() {
                Read_Sha.readSha result = new Read_Sha.readSha(this);
                int from_bitField0_ = this.bitField0_;
                int to_bitField0_ = 0;
                if ((from_bitField0_ & 0x1) == 1) {
                    to_bitField0_ |= 1;
                }
                result.sha_ = this.sha_;
            ...
            public Builder mergeFrom(Message other) {
                if ((other instanceof Read_Sha.readSha)) {
                    return mergeFrom((Read_Sha.readSha) other);
                }
                super.mergeFrom(other);
                return this;
            }

            public Builder mergeFrom(Read_Sha.readSha other) {
                if (other == Read_Sha.readSha.getDefaultInstance()) {
                    return this;
                }
                if (other.hasSha()) {
                    setSha(other.getSha());
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                Read_Sha.readSha parsedMessage = null;
                try {
                    parsedMessage = (Read_Sha.readSha) Read_Sha.readSha.PARSER.parsePartialFrom(input, extensionRegistry);
                } catch (InvalidProtocolBufferException e) {
                    parsedMessage = (Read_Sha.readSha) e.getUnfinishedMessage();
            ...
            public Builder setSha(ByteString value) {
                if (value == null) {
            ...
            public Builder clearSha() {
                this.bitField0_ &= -2;
                this.sha_ = Read_Sha.readSha.getDefaultInstance().getSha();
                onChanged();
                return this;
            }
