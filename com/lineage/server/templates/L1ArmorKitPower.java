...
public class L1ArmorKitPower {
    ...
    public L1ArmorKitPower(final int armorKitType, final int armorKitCount, final int ac, final int hp, final int mp, final int hpr, final int mpr, final int str, final int con, final int dex, final int wis, final int cha, final int intel, final int sp, final int mr, final int hit_modifier, final int dmg_modifier, final int bow_hit_modifier, final int bow_dmg_modifier, final int magic_dmg_modifier, final int magic_dmg_reduction, final int reduction_dmg, final int defense_water, final int defense_wind, final int defense_fire, final int defense_earth, final int regist_stun, final int regist_stone, final int regist_sleep, final int regist_freeze, final int regist_sustain, final int regist_blind, final int gift_box) {
