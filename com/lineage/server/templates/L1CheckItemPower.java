 ...
 * 身上持有道具給予能力系統
 */
public class L1CheckItemPower {
    private int _powermsg;
    private int _box_icon;
    private int _box_stringid;
    ...
    public L1CheckItemPower() {
        this._powermsg = 0;
        this._box_icon = 0;
        this._box_stringid = 0;
        this._open_string = 0;
        this._str = 0;
        this._dex = 0;
        this._con = 0;
    ...
    public int get_powermsg() {
        return this._powermsg;
    }

    public void set_powermsg(final int i) {
        this._powermsg = i;
    }

    public int get_box_icon() {
        return this._box_icon;
    }

    public void set_box_icon(final int i) {
        this._box_icon = i;
    }

    public int get_box_stringid() {
        return this._box_stringid;
    }

    public void set_box_stringid(final int i) {
        this._box_stringid = i;
    }
