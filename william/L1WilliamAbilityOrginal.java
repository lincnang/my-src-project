...
public class L1WilliamAbilityOrginal {
    ...
    public L1WilliamAbilityOrginal(final int itemId, final int itemType, final int itemType_Aromr, final int itemidok, final int[] itemid, final int evel, final int haveAbility, final int max_capacity, final String msg1, final String msg2, final String msg3, final int fixed_Or_Random, final int cleaning_ability, final int random, final byte addStr, final byte addDex, final byte addCon, final byte addInt, final byte addWis, final byte addCha, final int addMaxHp, final int addMaxMp, final int addMr, final int addSp, final int addWeaponDmg, final int addWeaponHit, final int addWeaponBowDmg, final int addWeaponBowHit, final int addHpr, final int addMpr, final int addAc, final int addFire, final int addWind, final int addEarth, final int addWater, final int PVPdmg, final int PVPdmg_R) {
        this._itemId = itemId;
